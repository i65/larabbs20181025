    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li>
                        <a href="{{ route('topics.create') }}" title="发帖子">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="user-avatar pull-left" style="margin-right: 8px;margin-top:-5px;">
                                <!-- <img src="https://iocaffcdn.phphub.org/uploads/images/201709/20/1/PtDKbASVcz.png?imageView2/1/w/60/h/60" class="img-responsive img-circle" alt="" width="30px" height="30px">                                 -->
                                <img src="{{ Auth::user()->avatar}}" class="img-responsive img-circle" alt="" width="30px" height="30px">                                
                            </span>
